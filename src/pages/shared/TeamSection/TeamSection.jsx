...
const TeamSection = () => {
    return (
        <div className="mb-8 md:mb-24 max-w-screen-xl mx-auto">
            <h2 className="text-4xl font-semibold text-center">Our Team Members</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 ml-20 md:ml-14 lg:ml-0 lg:grid-cols-4 gap-6 md:gap-8 mt-8 md:mt-12">
                <div className="mb-4 md:mb-0">
                    <img className="rounded-full duration-1000 hover:scale-105" src={image1} alt="" />
                    <div className="mt-4 pr-20 md:pr-16 lg:pr-4 text-center">
